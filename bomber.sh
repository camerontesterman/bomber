...
#set api-key
APIKEY="288c33e00276c97e996a0dbca6df0a2425f94301"
...
Commands:
   ...
   init         setup directories necessary for bomber script to run
...
case $COMMAND in
   ...
   "bomb")
      ...
      ;;
   "init")
      echo "initialzing directories"
      directories=($BOMBDIR $NAMES $URLS $XML $VIDEOS $VIDEONAMES $VIDEOFILES)
